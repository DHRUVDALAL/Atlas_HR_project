...
class Applicant(Base):
    ...
    gender = Column(String(10), nullable=False)  # MALE, FEMALE, OTHER, OTHERS
    ...
    applied_from = Column(String(20), nullable=True)  # LINKEDIN, NAUKRI, VENDOR, REFERRAL
    source_name = Column(String(100), nullable=True)  # Vendor name or referrer name
...
class FinalDecision(Base):
    ...
    hr_discussion = Column(Text, nullable=True)
    ceo_discussion = Column(Text, nullable=True)
    final_status = Column(String(20), nullable=False)  # SELECTED, REJECTED, HOLD
    offered_ctc = Column(Numeric(12, 2), nullable=True)
    joining_date = Column(Date, nullable=True)
    approved_by = Column(String(100), nullable=True)  # CEO or Admin email, nullable for drafts
